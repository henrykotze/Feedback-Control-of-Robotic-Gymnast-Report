...
The requirements set out for the balancing controller are to bring the robotic gymnast to the unstable equilibrium position from an initial condition range of:
$$ \vec{q_{i}} = 
\left \{
\begin{tabular}{c}
...
The response must have a settling time of 1 second and a percentage overshoot of XXX.\\

These requirements was selected to allow the swing-up controller with enough margin to bring the system to the inverted position. There exist a possibility for the balancing controller to bring the system to balance from further initial conditions due to the small velocities that could help the system to balance.
...
During the swing-up the $\alpha$ value was reduced as the robotic gymnast started nearer the unstable equilibrium position as seen below.
