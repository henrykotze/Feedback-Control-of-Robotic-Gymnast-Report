...
The shaft was modelled as a simple supported beam with the diameter being the smallest used in the actual design. This model is conservative due to the design being a supported in by 3 points and varies in shaft diameter. Figure \ref{label} shows the conservative model.
