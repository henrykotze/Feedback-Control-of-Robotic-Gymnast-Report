...
\begin{table}[!h]
	...
	\begin{tabular}{|p{4cm}|p{0.8cm}|p{2cm}|p{7cm}|}
		...
		\hline
		Engineering Design&3& \ref{sec:mechanical_hardware}, \ref{sec:electronic_hardware}, \ref{sec:software_requirements} & The mechanical, electronic and software designs were done to construct the robotic gymnast system.  	\\
		\hline
